...
Stream Monitoring Habitat Data Exchange Specifications (Draft%20Metric%20Level%20Exchange%20Specifications.docx) are a standard for exchanging metric-level habitat data based on the Darwin Core principle. These specifications were drafted by the Stream Habiat metric Data Intergration (https://www.pnamp.org/project/habitat-metric-data-integration) working group lead by the Pacific Northwest Aquatic Monitoring Partnership. 
