...
#### To the Datasets table from ODME2 Metadata table we add:
  * MetadataLink 
...
From ODME2 Results.MeasurementsResultsValues in this implementation we merged the following into the Sample Feature table 
  * MethodID 
  * MeasurementRemark 
  * DataValue 
...
#MeasurementOrFact %>%
 # kbl() %>%
  #kable_styling(bootstrap_options = c("striped", "hover"), font_size= 12)  
```
### Variable Controlled Vocabularies for Results Table 
